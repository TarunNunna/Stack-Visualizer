...
class StackVisualizer:
    ...
    def make_block(self, e):
        # Element containing block making
        try:
            ...
            self.entry_number = Label(self.stack_canvas, text=value, bg="black", fg="red", font=("Arial", 11, "bold"))
    ...
    def push_data(self):
        # Element entry process in stack container
        try:
    ...
    def pop_data(self):
        # Data containing block get out from stack container
